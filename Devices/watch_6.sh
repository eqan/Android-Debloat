...
pm disable-user --user 0 com.samsung.sree.classic
pm disable-user --user 0 com.samsung.sree
pm disable-user --user 0 com.samsung.sree.countdown
...
pm disable-user --user 0 com.samsung.sree.spin
pm disable-user --user 0 com.samsung.sree.digital
pm disable-user --user 0 com.samsung.android.calendar
pm disable-user --user 0 com.samsung.android.watch.alarm
pm disable-user --user 0 samsung.android.watch.findmywatch
pm disable-user --user 0 com.samsung.android.wear.shealth
pm disable-user --user 0 com.samsung.android.watch.findmyphone
pm disable-user --user 0 com.samsung.android.mediacontroller
pm disable-user --user 0 com.samsung.android.watch.flashlight
pm disable-user --user 0 com.samsung.android.sdk.handwriting.watch
pm disable-user --user 0 com.samsung.android.aircommandmanager
pm disable-user --user 0 com.samsung.android.gru
pm disable-user --user 0 com.samsung.android.apps.wearable.recent
...
pm disable-user --user 0 com.sds.emm.cloud.knox.samsung
pm disable-user --user 0 com.android.devicediagnostics
pm disable-user --user 0 com.google.android.gsf
pm disable-user --user 0 com.samsung.android.watch.findmywatch
